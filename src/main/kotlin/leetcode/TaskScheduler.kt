...
//    println(leastInterval(charArrayOf('A', 'A', 'B', 'B', 'B'), 2))
//    println(leastInterval(charArrayOf('A', 'B'), 2))
...
//                    result.add('0')
//                } else {
//                    result.add(singleList.removeFirst())
//                }
//                split++
//            }
//    }
